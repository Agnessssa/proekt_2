...
def start(message):
    bot.send_message(message.chat.id, "\t Здравствуйте! Hallo! Ciao! Hello! "
                                      ...
                                      "\n\n\t ✍️✍️ Введите команду /help, если что-то не работает")

@bot.message_handler(commands=['help'])
def start(message):
    bot.send_message(message.chat.id, "Убедитесь, что вы правильно ввели команду, или нажмите на нее в меню команд")
